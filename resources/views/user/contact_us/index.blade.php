        ...
        <form id="contact_form" action="{{ route('contacts.store') }}" method="post">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                <div class="Department ">
                    ...
                    <select class="form-control form_sty" placeholder="Department" name="department" id="department_input"
                        required="">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                <div class="name">
                    ...
                    <input class="form-control form_sty" type="text" placeholder="Name" name="name" id="name_input">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                <div class="email">
                    ...
                    <div class="input_icon">
                    <input class="form-control form_sty" type="email" placeholder="Email" name="email" id="email_input">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                <div class="telephone">
                    ...
                    <div class="input_icon">
                    <input class="form-control form_sty" type="text" placeholder="Phone" name="phone" id="telephone_input">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                <div class="refrence">
                    ...
                    <input class="form-control form_sty" type="text" placeholder="Reference" name="reference"
                        ...
                        <i class="bi bi-book icon_shp"></i> </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                <div class="subject">
                    ...
                    <div class="input_icon">
                    <input class="form-control form_sty" type="text" placeholder="Subject" name="subject" id="subject_input">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                <div class="message">
                    ...
                    <textarea class="form-control form_sty" name="message" placeholder="Message" id="message_input" cols="30"
                        rows="5"></textarea>
                </div>
            </div>

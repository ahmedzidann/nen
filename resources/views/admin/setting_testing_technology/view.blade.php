        ...
        <div class="page-content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ str_replace('-', ' ', ucfirst('SidebarResources')) }}
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <br>
                    <a href="{{ route('admin.setting_technology_testing.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
...
@section('jsadmin')
    ...
    <script>
        ...
        let url = '{{ route('admin.setting_technology_testing.index') }}'
        ...
        $(document).ready(function() {
            ...
            bulkDelete(table, "{{ route('admin.setting_technology_testing.delete_bulck') }}");

    ...
    public function show(Request $request,$language)
    {
            if ($request->ajax()) {
                ...
                return Datatables::of($data) 
                        ...
                        ->addColumn('action', function($row) use ($category,$subcategory) {return'<div class="d-flex order-actions"> <a href="'.route('admin.project.edit',[$row->id,'category='.$category,'subcategory='.$subcategory]).'" class="m-auto"><i class="bx bxs-edit"></i></a> ';})

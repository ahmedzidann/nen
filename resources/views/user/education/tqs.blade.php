            ...
            <div class="tab-content certificates_h" id="pills-tabContent">
                @foreach ($subPartners as $sub)
                    <div class="tab-pane fade @if ($loop->first) show active @endif"
                        id="pills-{{ $sub->slug }}" role="tabpanel" aria-labelledby="pills-{{ $sub->slug }}-tab"
                        tabindex="0">
                            ...
                            <div class="accordion accordion_flex" id="accordionExample">
                                ...
                                @empty
                                    <div class="empty_state">
                                        <svg style="width: 50%;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 650 512"
                                            id="empty-box">
                                            <path fill="#e0dfdf"
                                            ...
                                            <rect width="159.84" height="145.44" x="217.561" y="231.797" fill="#d90505">
                                            </rect>
                                            <rect width="84.96" height="145.44" x="377.401" y="231.797" fill="#990000">
                                            </rect>
                                            <path fill="#000"
                                            ...
                                            <rect width="110.853" height="78.366" x="246.893" y="153.791" fill="#ee781d">
                                            </rect>
                                            <path fill="#e0dfdf"
                                            ...
                                            <rect width="3.356" height="28.368" x="297.402" y="192.301" fill="#d90505"
                                                rx="1.678">
                                            </rect>
                                            ...
                                            <path fill="none" stroke="#990000" stroke-linecap="round"

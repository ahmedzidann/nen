...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form.filter','data' => ['nameone' => 'Create question','nametwo' => 'Create Contact us','customzie' => 'tabproject','routeCreatesectionTwo' => $routeCreatesectionTwo,'route' => $routeCreate]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['nameone' => 'Create question','nametwo' => 'Create Contact us','customzie' => 'tabproject','routeCreatesectionTwo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($routeCreatesectionTwo),'route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($routeCreate)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <table id="yajra-datatable"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(TranslationHelper::translate(ucfirst('type')??'')); ?></th>
...
<script src="<?php echo e(asset('admin/project/tabs/help/js/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/nendemo2024/public_html/resources/views/admin/project/tabs/help/view.blade.php ENDPATH**/ ?>
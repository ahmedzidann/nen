...
@section('titleadmin')
    {{ str_replace('-', ' ', ucfirst(TranslationHelper::translate('Media Category' . ' View'))) }}
@endsection
@section('cssadmin')
@endsection
        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <br>
                    <a href="{{route('admin.media-categories.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
...
@section('jsadmin')
    ...
    <script>
        ...
        let url = '{{ route('admin.media-categories.index') }}'
        ...
        $(document).ready(function() {
            ...
            bulkDelete(table, "{{ route('admin.media-categories.delete_bulck') }}");

                                                    ...
                                                    @if ($loop->first)
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <x-admin.form.dropdown disabled="" required=""
                                                                :foreach="$allPage" name="pages_id" nameselect="pages"
                                                                :model="$StaticTable">
                                                ...
                                                <x-admin.form.dropdown disabled="" required="" :foreach="$allTabs"
                                                    ...
                                                    @if ($loop->first)
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <x-admin.form.input :model="$StaticTable" nameImage="Solution"
                                                    ...
                                                    @if ($loop->first)
                                                        ...
                                                        <div class="col-md-6 mb-4">
                                                            ...
                                                            <x-admin.form.input old="fax" name="fax" type="text"
                                                        ...
                                                        <div class="col-md-6 mb-4">
                                                            ...
                                                            <x-admin.form.input old="phone2" name="phone2"
                                                                type="text" required="" placeholder="another phone"
                                                                class="form-control valid" :value="$StaticTable->email">
                                                            </x-admin.form.input>
                                                            <x-admin.form.label-end star="*"
                                                                name="please enter another phone">
                                                            </x-admin.form.label-end>
                                                        </div>
                                                        <div class="col-md-6 mb-4">
                                                            <x-admin.form.label-first star="" class="form-label"
                                                            ...
                                                            <x-admin.form.input old="whatsapp" name="whatsapp"
                                                                type="text" required="" placeholder="whatsapp"
                                                                class="form-control valid" :value="$StaticTable->email">
                                                            </x-admin.form.input>
                                                            <x-admin.form.label-end star=""
                                                                name="please enter whatsapp">
                                                            </x-admin.form.label-end>
                                                        </div>
                                                        <div class="col-md-6 mb-4">
                                                            <x-admin.form.label-first star="" class="form-label"

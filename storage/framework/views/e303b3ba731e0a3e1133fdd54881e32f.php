...
<?php endif; ?>
        ...
        <?php if(Request()->category == 'about' && Request()->subcategory == 'certificates' && Request()->item == 'section-one'): ?>
...
<script src="<?php echo e(asset('admin/about/certificates/js/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\nen\resources\views/admin/about/certificates/view.blade.php ENDPATH**/ ?>
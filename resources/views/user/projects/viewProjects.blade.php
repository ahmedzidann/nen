        ...
        <div class="tabs-items mt-md-4 mt-3">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link proj_bttn {{$loop->first ? "active":"" }}" id="pills-tab-{{$tab->slug}}"
                        data-bs-toggle="pill" data-bs-target="#pills-{{$tab->slug}}" type="button" role="tab"
                        aria-controls="pills-{{$tab->slug}}" aria-selected="false" tabindex="-1">{{$tab->name}}
                    </button>
            ...
            <div class="tab-content mt-md-4 mt-3 text-start" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-about" role="tabpanel"
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-7 order-md-2">
                                <div class="who-us-titles text-start">
                                    ...
                                    <p id="shortDescription" class="short-description py-4 lh-lg text-muted">
                                        {!! $about->shortDescription !!}
                                    </p>
                                    @endif
                                    @if(!empty($about->description))
                                    <p id="fullDescription"
                                        class="full-description py-4 lh-lg text-muted {{ strlen($about->description)>= 400 ? 'p_clamp_4' : ''}}">
                            ...
                            <div class="col-md-5 order-md-1">
                                <div class="image-box">
                                    <img src="{{ asset($about->getFirstMediaUrl('AboutTabs')) }}" class="img-fluid"
                                        loading="lazy"
                                        onerror="this.onerror=null;this.src='{{ asset('content/images/not-found/no-image.svg') }}';"
                                        alt="AboutTabs">
                                </div>
                    ...
                    <div id="investors-statisctics-section"
                        ...
                        <div class="statisctic-items d-flex align-items-center justify-content-around gap-3 flex-wrap">
                            <div
                                ...
                                <img class="image-icons" src="{{asset('content')}}/images/small_icon/Vector (1).png"
                                    loading="lazy"
                                    onerror="this.onerror=null;this.src='{{ asset('content/images/not-found/no-image.svg') }}';"
                                    alt="vector1">
                            ...
                            <div
                                class="statisctic-item d-flex flex-column align-items-center justify-content-center gap-3">
                                <img class="image-icons" src="{{asset('content')}}/images/small_icon/Vector.png"
                                    loading="lazy"
                                    onerror="this.onerror=null;this.src='{{ asset('content/images/not-found/no-image.svg') }}';"
                                    alt="vector2">
                                <h6 class="title text-secondary-color fs-5 fw-semibold fst-italic text-uppercase">
                            ...
                            <div
                                class="statisctic-item d-flex flex-column align-items-center justify-content-center gap-3">
                                <img class="image-icons" src="{{asset('content')}}/images/small_icon/people.png"
                                    loading="lazy"
                                    onerror="this.onerror=null;this.src='{{ asset('content/images/not-found/no-image.svg') }}';"
                                    alt="vector3">
                                <h6 class="title text-secondary-color fs-5 fw-semibold fst-italic text-uppercase">
                    ...
                    <div class="second-tabs-items">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active tab_active" id="chalange_btn_tab" data-bs-toggle="pill"
                                    data-bs-target="#challang_tab" type="button" role="tab" aria-controls="challang_tab"
                                    aria-selected="true">
                                    Challenge
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link btn_tabs" id="solution_btn_tab" data-bs-toggle="pill"
                                    data-bs-target="#solution_tab" type="button" role="tab" aria-controls="solution_tab"
                                    aria-selected="false">
                                    Solution
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link btn_tabs" id="result_btn_tab" data-bs-toggle="pill"
                                    data-bs-target="#result_tab" type="button" role="tab" aria-controls="result_tab"
                                    aria-selected="false">
                                    Result
                                </button>
                            </li>
                        ...
                        <div class="tab-content text-start" id="pills-tabs">
                            ...
                            <div class="tab-pane fade" id="solution_tab" role="tabpanel"
                                aria-labelledby="solution_btn_tab" tabindex="0">{{ $about['solution'] }}</div>
                            @endif
                            @if (!empty($about['result']))
                            <div class="tab-pane fade" id="result_tab" role="tabpanel" aria-labelledby="result_btn_tab"
                                tabindex="0">
                                {{ $about['result'] }}
                            </div>
                            @endif
                            ...
                            <div class="program-card {{ $loop->first ? '' : '' }}">
                                ...
                                <div class="items-card">
                                    <div class="image-box-card">
                                        <img src="{{ asset($program->getFirstMediaUrl('firstImage')) }}" loading="lazy"
                                            onerror="this.onerror=null;this.src='{{ asset('content/images/not-found/no-image.svg') }}';"
                                            alt="vector">
                                    </div>
                                    <h3 class="title mt-3">
                                    ...
                                    <p class="description {{ strlen($program->description) >= 200 ? 'p_clamp' : '' }}">
                ...
                <div class="tab-pane fade" id="pills-join-us" role="tabpanel" aria-labelledby="pills-join-us-tab"
                    ...
                    <div class="edu-statisctics rounded-3 overflow-hidden p-4">
                        <h3 class="line-before text-warning mb-3">
                            Register Steps
                        </h3>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="flex_jon mt-md-4 mt-3">
                            ...
                            <div class="terms_img">
                                ...
                                <img src="{{asset($joinus->getFirstMediaUrl('JoinusTerms'))}}" loading="lazy"
                                    onerror="this.onerror=null;this.src='{{ asset('content/images/not-found/no-image.svg') }}';"
                                    alt="vector">
                                @endif
                            </div>
    ...
    <div class="tabs_div">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link proj_bttn {{$loop->first ? "active":"" }}" id="pills-tab-{{$tab->slug}}"
                    data-bs-toggle="pill" data-bs-target="#pills-{{$tab->slug}}" type="button" role="tab"
                    aria-controls="pills-{{$tab->slug}}" aria-selected="false" tabindex="-1">{{$tab->name}} </button>
            ...
            <div class="tab-pane fade show active" id="pills-about" role="tabpanel" aria-labelledby="pills-about-tab"
                ...
                <div class="who_us">
                    <div class="who_us_titel">
                        ...
                        @if (strlen($about->description)>= 400)
                        <a href="#" onclick="toggleDescription2(this)" id="learnMoreBtn" class="btn_detail">Show
                            More</a>
                        @endif
                ...
                <div class="tabs_div2">
                    ...
                    <div class="tab-content" id="pills-tabs">
                        ...
                        @if (!empty($about['solution']))
                        <div class="tab-pane fade" id="solution_tab" role="tabpanel" aria-labelledby="solution_btn_tab"
                            tabindex="0">{{ $about['solution'] }}</div>
                        @endif
                        @if (!empty($about['result']))
                        <div class="tab-pane fade" id="result_tab" role="tabpanel" aria-labelledby="result_btn_tab"
                            tabindex="0">{{ $about['result'] }}</div>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="program_sec">
                    ...
                    <div class="card all_program_card">
                        ...
                        <div class="programe_content">
                            ...
                            <h3>{{ $program->title }}</h3>
                            <p class="text-start {{ strlen($program->description)>= 200 ? "p_clamp":''}} ">
                                {{ html_entity_decode(strip_tags($program->description)) }}</p>
                            @if (strlen($program->description)>= 200)
                            {{-- <a  role='btn' onclick="toggleDescription(this)" class="read_more" >Read More <i class="bi bi-chevron-down"></i></a> --}}
                            <button href="#" onclick="toggleDescription(this)" class="show_bttn">Show More <i
            ...
            <div class="tab-pane fade" id="pills-help" role="tabpanel" aria-labelledby="pills-help-tab" tabindex="0">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne-{{$helpItem['id']}}" class="accordion-collapse collapse"

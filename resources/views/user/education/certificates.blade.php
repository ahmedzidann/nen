                                                ...
                                                <div class="icons-data">
                                                    <p class="icons-item">
                                                        @if (isset($item->files[0]) && !empty($item->files[0]))
                                                            <img
                                                                src="{{ url('content/images/small_icon/archive-book.png') }}">
                                                    ...
                                                    <p class="icons-item">
                                                        @if (array_key_exists(0, $item?->links->toArray()) && $item->links[0]->reference)
                                                            <img
                                                                src="{{ url('content/images/small_icon/global.png') }}"><span><a
                                                                    class="ref_coloring"
                                        ...
                                        <div class="card card_styles">
                                            <div class="card_content">
                                                ...
                                                <div class="iso_titels ">
                                                    <span
                                                        class="description text-start {{ strlen($item->description) >= 200 ? 'p_clamp' : '' }}">
                                                        {{ html_entity_decode(strip_tags($item->description)) }}
                                                    </span>
                                                        ...
                                                        <p>
                                                            ...
                                                            @if (array_key_exists(0, $item?->links->toArray()) && $item->links[0]->reference)
                                                                <img
                                                                    src="{{ url('content/images/small_icon/global.png') }}"><span><a
                                                                        target="_blank" class="ref_coloring"
                                                                        href="{{ $item->links[0]->reference }}">Website</a></span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>

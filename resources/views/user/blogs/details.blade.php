...
<div class="page px-lg-3 pb-3">
    ...
    <div class="bread-crumb fs-6" id="breadCrumb">
        <span><a href="index.html" class=" text-dark d-flex gap-1 align-items-center">
                <svg width="40" class="no-rotate" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="share-popup" id="sharePopup">
                <div class="share-container">
                    ...
                    <div class="share-icons d-flex gap-2 ">
                        ...
                        <button id="linkedinShareButton" name="linkedinShare" aria-label="Share on LinkedIn"> <svg
                                class="no-rotate" width="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                fill="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                        ...
                        <button id="whatsappShareButton" name="whatsappShare" aria-label="Share on WhatsApp"
                            title="Share this content on WhatsApp"><svg width="30" viewBox="0 0 32 32" fill="none"
                                class="no-rotate" xmlns="http://www.w3.org/2000/svg">
                                <g stroke-width="0"></g>
                ...
                <div class="cards">
                    <div class="categorates">
                        ...
                        <div class="d-flex flex-wrap gap-1 pt-3 align-items-center" id="categorates">
                            ...
                            <div class="gap-0">
                                <button class="button-2 d-flex align-items-center gap-1" name="tipsAndHacks"
                                    aria-label="Explore Tips & Hacks" title="Get useful tips and hacks">
                                    <svg class="no-rotate" width="15" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g stroke-width="0"></g>
                                        <g stroke-linecap="round" stroke-linejoin="round"></g>
                            ...
                            <div class="gap-0">
                                <button class="button-2 d-flex align-items-center gap-1" name="lifestyle"
                                    aria-label="Explore Lifestyle" title="Learn about lifestyle topics">
                                    <svg class="no-rotate" width="15" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g stroke-width="0"></g>
                                        <g stroke-linecap="round" stroke-linejoin="round"></g>
                            ...
                            <div class="gap-0">
                                <button class="button-2 d-flex align-items-center gap-1" name="destination"
                                    aria-label="Explore Destinations" title="Discover new travel destinations">
                                    <svg class="no-rotate" width="15" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g stroke-width="0"></g>
                                        <g stroke-linecap="round" stroke-linejoin="round"></g>

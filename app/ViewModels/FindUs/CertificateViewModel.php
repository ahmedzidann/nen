...
class CertificateViewModel extends ViewModel
{
    public  $admin;
    public  $type;
    public  $categories;
    ...
    {
        $this->admin = is_null($admin) ? new Certificate(old()) : $admin;
        ...
        $this->routeCreate = route('admin.certificates.create');
        $this->routeView = route('admin.certificates.index');
    ...
    public function action(): string
    {
        return is_null($this->admin->id)
            ...
            : route('admin.certificates.update', $this->admin->id);
    }

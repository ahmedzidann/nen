                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            <div class="col-md-9 mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <x-admin.form.input :model="$StaticTable" nameImage="Technology"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <video controls width="500">
                                                        <source src="{{url('storage/'.$StaticTable->video)}}" type="video/mp4">
                                                        ...
                                                        <div class="col-md-12 mb-4 row">
                                                            <div class="col-md-4 row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                   ...
                                                                   <a href="{{ url('storage/Testing/' . $file->file) }}" class="btn btn-success donload-input-file" download>  <i class="bx bxs-download"></i>&nbsp;</a>

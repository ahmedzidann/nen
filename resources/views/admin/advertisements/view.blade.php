        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <br>
                    <a href="{{route('admin.advertisements.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
...
@section('jsadmin')
    ...
    <script>
        ...
        let url = '{{ route('admin.advertisements.index') }}'
        ...
        $(document).ready(function() {
            ...
            bulkDelete(table, "{{ route('admin.advertisements.delete_bulck') }}");

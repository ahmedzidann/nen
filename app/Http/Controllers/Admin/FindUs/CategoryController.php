...
use App\ViewModels\FindUs\CategoryViewModel;
...
class CategoryController extends Controller
{
    ...
    {
        return view('category.view',new CategoryViewModel());
    }
    public function show(Request $request,$language)
    {
            if ($request->ajax()) {
                ...
                return Datatables::of($data)
                        ...
                        ->addColumn('action', function($row){return'<div class="d-flex order-actions"> <a href="'.route('admin.categories.edit',$row->id).'" class="m-auto"><i class="bx bxs-edit"></i></a> ';})
    ...
    {
        return view('category.crud',new CategoryViewModel());
    }
    public function store(Request $request):RedirectResponse
    {
        ...
        return redirect()->route('admin.categories.index')->with('add','Success Add Admin');
    }
    public function edit(Admin $admin):View
    {
        return view('category.crud',new CategoryViewModel($admin));
    }

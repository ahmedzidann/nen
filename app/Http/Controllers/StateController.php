...
use App\ViewModels\CountryView\StateViewModel;
use Carbon\Carbon;
...
class StateController extends Controller
{
    ...
    {
        return view('state.view',new StateViewModel());
    }
    public function show(Request $request,$language)
    {
            if ($request->ajax()) {
                ...
                return Datatables::of($data)
                        ...
                        ->addColumn('action', function($row){return'<div class="d-flex order-actions"> <a href="'.route('admin.states.edit',$row->id).'" class="m-auto"><i class="bx bxs-edit"></i></a> ';})
    ...
    public function create():View
    {
        ...
        return view('state.crud',new StateViewModel());
    }
    public function store(Request $request):RedirectResponse
    {
        ...
        return redirect()->route('admin.states.index')->with('add','Success Add Admin');
    }
    public function edit(Admin $admin):View
    {
        return view('admin.states.crud',new StateViewModel($admin));
    }
    public function update(UpdateAdminRequest $request, Admin $admin):RedirectResponse
    {
        app(UpdateAdminAction::class)->handle($admin,$request->validated());
        return redirect()->route('admin.states.index')->with('edit','Update Admin');
    }

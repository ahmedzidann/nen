                        ...
                        <div class="tab-pane fade @if ($loop->first) show active @endif"
                                            ...
                                            <div class="card h-100 new-card-style">
                                                ...
                                                <div class="d-flex w-100 justify-content-between mb-2 small-details px-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span>Price: {{ $item->price ?? '0.0' }}</span>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="background:white; width:100%">
                                                        <div class="card-buttons-container">
                                                          ...
                                                          id="view_simple-[#815]">
                                                            ...
                                                            <a href="#" class="btn custom-btn btn-outline"
                                                        ...
                                                        <div class="card-buttons-container">
                                                            <a href="{{ $item->getFirstMediaUrl('StaticTable2') }}"
                                                            ...
                                                            <a href="{{ $item->url }}" class="btn custom-btn btn-outline"
                                                                target="_blank">
                            ...
                            <div class="accordion accordion-flush faq-custom-style"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingOne-{{ $sub->slug }}">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#flush-collapseOne-{{ $sub->slug }}"
                                            aria-expanded="false" aria-controls="flush-collapseOne-{{ $sub->slug }}">
                                            What are the prerequisites for this course?
                                        </button>
                                    </h2>
                                    <div id="flush-collapseOne-{{ $sub->slug }}" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingOne-{{ $sub->slug }}"
                                        data-bs-parent="#faqAccordion-{{ $sub->slug }}">
                                        <div class="accordion-body">
                                            There are no formal prerequisites. However, a basic understanding of [Relevant
                                            Topic] would be beneficial for the best learning experience.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingTwo-{{ $sub->slug }}">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo-{{ $sub->slug }}"
                                            aria-expanded="false" aria-controls="flush-collapseTwo-{{ $sub->slug }}">
                                            How is this course different from others?
                                        </button>
                                    </h2>
                                    <div id="flush-collapseTwo-{{ $sub->slug }}" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingTwo-{{ $sub->slug }}"
                                        data-bs-parent="#faqAccordion-{{ $sub->slug }}">
                                        <div class="accordion-body">
                                            Our course stands out due to its hands-on approach, real-world case studies, and
                                            mentorship from industry experts. We focus on practical skills you can apply
                                            immediately.
                                        </div>
                                    </div>
                                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            itemDetailsModal.addEventListener('show.bs.modal', function(event) {
                ...
                if (item) {
                    ...
                    if (item.reference_link) {
                        modalReferenceBtn.href = item.reference_link;
                        modalReferenceBtn.style.display = 'block';
                    }
                    if (item.url) {
                        modalWebsiteBtn.href = item.url;
            ...
            registerModal.addEventListener('show.bs.modal', function(event) {
                ...
                const dummyRegistrations = [{
                    name: 'Arab Medical',
                    imageUrl: 'https://dev.nendemo2024.xyz/media/166/Image-(7).png'
                }, {
                    name: '6 October Academy',
                    imageUrl: 'https://dev.nendemo2024.xyz/media/268/October-High-Institute-for-Engineering-&-Technology-(OHI).jpeg'
                }, {
                    name: 'El-Motkhasis for Computer Science',
                    imageUrl: 'https://dev.nendemo2024.xyz/media/270/El-Motkhasis-for-Computer-Science.png'
                }, {
                    name: 'Oxford Academy',
                    imageUrl: 'https://dev.nendemo2024.xyz/media/273/Oxford-Academy.jpeg'
                }, {
                    name: 'Alsafwa Academy (S.T.I.T)',
                    imageUrl: 'https://dev.nendemo2024.xyz/media/274/Alsafwa-Academy-(S.T.I.T).png'
                }, {
                    name: 'Canadian Institute for training and development (CITD)',
                    imageUrl: 'https://dev.nendemo2024.xyz/media/277/Canadian-Institute-for-training-and-development-(CITD).png'
                }, ];

...
@section('content')
    <div class="about_content">
        ...
        <div class="tabs_div">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link proj_bttn {{$loop->first ? "active":"" }}" id="pills-tab-{{$tab->slug}}" data-bs-toggle="pill" data-bs-target="#pills-{{$tab->slug}}" type="button" role="tab" aria-controls="pills-{{$tab->slug}}" aria-selected="false" tabindex="-1">{{$tab->name}} </button>
                        ...
                        <div class="tab-pane fade" id="pills-join-us" role="tabpanel"
                            ...
                            <div class="terms_sec">
                                ...
                                <div class="flex_jon">
                                    ...
                                    <div class="terms_img">
                                        @if ($projects->getJoinus->first()->getFirstMediaUrl('JoinusTerms'))

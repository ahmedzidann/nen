                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <x-admin.form.label-first star="*" class="form-label"
                                                    name="Register Description  {{ $item->name  }}">
                                                ...
                                                <x-admin.form.label-end star="*"
                                                    name="please enter Register Description  {{ $item->name  }}">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <x-admin.form.input :model="$StaticTable" nameImage="JoinusTabs"
                                                        ...
                                                        placeholder="Please Enter Register  Image" id="image" class="dropify"
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <x-admin.form.text old="{{ 'sub_description.'.$item->key }}"
                                                    name="{{ 'sub_description'.'['.$item->key.']' }}" type="text"
                                                    placeholder="Terms {{ ucfirst($item->name)  }}"
                                                    :value="$StaticTable->translate('sub_description', $item->key)">
                                                </x-admin.form.text>
                                                <x-admin.form.label-end star="*"
                                                    name="please enter Terms  {{ $item->name  }}">
                                                </x-admin.form.label-end>
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <x-admin.form.input :model="$StaticTable" nameImage="JoinusTerms"
                                                        ...
                                                        placeholder="Please Enter Terms Image" id="image2" class="dropify"
                                                        DataHeight="300" accept=".jpg, .png, image/jpeg, image/png">
                                                    </x-admin.form.input>
                                                </div>
                                            </div>

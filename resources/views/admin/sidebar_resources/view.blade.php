        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <br>
                    <a href="{{ route('admin.sidebar-resources.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
...
@section('jsadmin')
    ...
    <script>
        ...
        let url = '{{ route('admin.sidebar-resources.index') }}'
        ...
        $(document).ready(function() {
            ...
            bulkDeleteResources(table, "{{ route('admin.sidebar-resources.delete_bulck') }}");

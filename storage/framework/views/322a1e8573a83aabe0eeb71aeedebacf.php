					...
					?>
						...
						<li><a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>Investors</a>
							<ul>
								...
								<li class="<?php echo e($route=='about' && $route_two=='investors' && Request()->item=='section-five' ?'mm-active':''); ?>"><a href="<?php echo e(route('admin.about.investors.index',['category=about','subcategory=investors','item=section-five'])); ?>" ><i class='bx bx-radio-circle'></i>Section five</a></li>
							</ul>
						</li>
						...
						<li><a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>Our Team</a>
							<ul>
								...
								<li class="<?php echo e($route=='about' && $route_two=='our-team' && Request()->item=='member-board' ?'mm-active':''); ?>"><a href="<?php echo e(route('admin.about.our-team.index',['category=about','subcategory=our-team','item=member-board'])); ?>" ><i class='bx bx-radio-circle'></i>Member Board </a></li>
								<li class="<?php echo e($route=='about' && $route_two=='our-team' && Request()->item=='financial-department' ?'mm-active':''); ?>"><a href="<?php echo e(route('admin.about.our-team.index',['category=about','subcategory=our-team','item=financial-department'])); ?>" ><i class='bx bx-radio-circle'></i>Financial Department</a></li>
								<li class="<?php echo e($route=='about' && $route_two=='our-team' && Request()->item=='marketing-department' ?'mm-active':''); ?>"><a href="<?php echo e(route('admin.about.our-team.index',['category=about','subcategory=our-team','item=marketing-department'])); ?>" ><i class='bx bx-radio-circle'></i>Marketing Department</a></li>
								<li class="<?php echo e($route=='about' && $route_two=='our-team' && Request()->item=='it-department' ?'mm-active':''); ?>"><a href="<?php echo e(route('admin.about.our-team.index',['category=about','subcategory=our-team','item=it-department'])); ?>" ><i class='bx bx-radio-circle'></i>It Department</a></li>
							</ul>
						</li>
...
<?php /**PATH /home2/nendemo2024/public_html/resources/views/admin/layouts/sidebar/sidebar.blade.php ENDPATH**/ ?>
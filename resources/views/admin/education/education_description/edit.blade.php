                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select w-100" data-placeholder="Choose type"
                                            name="type">
                                            <option value="main" {{  $description->type == 'main' ? 'selected' : ''  }}> main</option>
                                            <option value="sub_main" {{  $description->type == 'sub_main' ? 'selected' : ''  }}> submain</option>
                                    ...
                                    <div class="col-md-12">
                                        <label
                                            ...
                                            <span style="color: red">{{ $star ?? '' }}</span> </label> <br>
                                        <select id="page_id" class="form-select w-100" data-placeholder="Choose Page"
                                            name="page_id">
                                            ...
                                            <option value="{{ $page->id }}" {{  $description->page_id == $page->id ? 'selected' : ''  }}>
                                                {{ $page->slug }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" form-group col-md-12">
                                        <label
                                            class="{{ $class ?? 'form-label' }}">{{ ucfirst(TranslationHelper::translate('Sub Main')) }}
                                            <span style="color: red">{{ $star ?? '' }}</span> </label> <br>
                                        <select class="form-select w-100" id="pages" data-placeholder="Choose Tab"
                                            name="sub_page_id">
                                            @if(isset($sub_pages)&& !empty($sub_pages) && $description->type=='sub_main')
                                            @foreach ($sub_pages as $page)
                                            <option value="{{ $page->id }}" {{  $description->sub_page_id == $page->id ? 'selected' : ''  }}>
                                                {{ $page->slug }}
                                            </option>
                                            @endforeach
                                            @endif

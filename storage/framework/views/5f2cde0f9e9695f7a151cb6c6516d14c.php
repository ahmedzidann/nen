                    ...
                    <tfoot>
                        <tr class="odd">
                            ...
                            <td><input type="text" class="form-control filter-input"
                                    ...
                                    data-column="1"></td>
                            <td><input type="text" class="form-control filter-input"
                                    placeholder="Search for created_at..." data-column="2"></td>
                            <th><?php echo e(TranslationHelper::translate(ucfirst('Processes')??'')); ?></th>
                        </tr>
                    </tfoot>
                </table>
...
<script src="<?php echo e(asset('admin/roles/js/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hatem/Desktop/nen/resources/views/admin/roles/view.blade.php ENDPATH**/ ?>
			...
			<div class="wrap-login100">
                ...
                <form method="POST" class="login100-form validate-form" action="{{ route('register') }}">
					...
					<div class="wrap-input100 validate-input"  >
						<input class="input100" type="text" value="{{ old('name') }}" name="name" autocomplete="name" placeholder="Username">
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" id="password" type="password" value="__('Password')" name="password_confirmation" placeholder="Password confirmation" required autocomplete="new-password" >
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>

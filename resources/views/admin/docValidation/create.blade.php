                                                        ...
                                                        <div class="col-md-12 mb-4 row">
                                                            <div class="col-md-10 row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <x-admin.form.input name="{{ 'details_title'.'['.$translationFirst->key.'][]' }}" type="text" required="" placeholder="title {{ $translationFirst->name  }}" class="form-control valid">
                                                                    </x-admin.form.input>
                                                                </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <button data-id="1" type="button" class="btn btn-danger delete-input">
    ...
    // Function to create a new input field
        ...
        $(document).on('click','#add-input',function (){
            ...
            var row=`
                                                                 ...
                                                                 <div id="input-template-${random}"  class="input-temp" style="">
                                                        <div class="col-md-12 mb-4 row">
                                                            <div class="col-md-10 row">
            ...
            <div class="col-md-2">
                <button data-id="${random}" type="button" class="btn btn-danger delete-input">
                    <i class="bx bxs-trash"></i>&nbsp;</button>
            </div>
        </div>
        <!-- Add more input fields as needed -->

...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <x-admin.form.filter nameone="Create question" nametwo="Create Contact us" customzie="tabproject" :routeCreatesectionTwo="$routeCreatesectionTwo" :route="$routeCreate"></x-admin.form.filter>
...
@endsection
@section('jsadmin')
<script src="{{ asset('admin/project/tabs/help/js/index.js') }}"></script>
@endsection
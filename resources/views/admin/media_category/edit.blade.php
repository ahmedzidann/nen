...
@section('titleadmin')
    {{ str_replace('-', ' ', ucfirst(TranslationHelper::translate('Media Category'))) }}
@endsection
@section('cssadmin')
@endsection
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ str_replace('-', ' ', ucfirst('Media Category')) }}
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" action="{{ route('admin.media-categories.update', $category->id) }}"
                                            ...
                                            <div class="card-body p-4 row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('title.' . $lang->key, $category->getTranslation('title', $lang->key)) }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="mini_desc_{{ $lang->key }}" name="mini_desc[{{ $lang->key }}]"
                                                        rows="2">{{ old('mini_desc.' . $lang->key, $category->getTranslation('mini_desc', $lang->key)) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach

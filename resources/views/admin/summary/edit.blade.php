                                                ...
                                                <div class="card-body p-4 row">
                                                    ...
                                                    @if ($loop->first)
                                                        <div class="col-md-6 mb-4">
                                                            ...
                                                            <x-admin.form.dropdown disabled="" required=""
                                                                ...
                                                                :model="$StaticTable" :param="$StaticTable->pages_id" name="pages_id">
                                                            </x-admin.form.dropdown>
                                                        </div>
                                                        <div class="col-md-6 mb-4">
                                                            <label for="pages">Select Child Page</label>
                                                            <br>
                                                            <select class="form-select" id="pages" name="childe_pages_id">
                                                                <option value="{{ $StaticTable->childe_pages_id }}" disabled selected>Select a child page
                                                                </option>
                                                                <option value="{{ $StaticTable->chiled?->id }}" selected>
                                                                    {{ $StaticTable->chiled?->slug }}</option>
                                                            </select>
                                                        </div>
                                                    @endif
                                                    <div class="col-md-12 mb-4">
                                                    ...
                                                    @if ($loop->first)
                                                        <div class="col-md-9 mb-4">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <x-admin.form.input :model="$StaticTable" nameImage="Summary"
...
@section('jsadmin')
    ...
    <script>
        function delete_link(button) {
            ...
            var url = '{{ route('admin.summary-delete.link', ':link_id') }}';

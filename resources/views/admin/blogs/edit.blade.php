                ...
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" action="{{ route('admin.blogs.update', ['blog' => $blog->id]) }}"
                                            ...
                                            <div class="card-body p-4 row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('title.' . $lang->key, $blog->getTranslation('title', $lang->key)) }}"
                                                        required>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="mini_desc_{{ $lang->key }}" name="mini_desc[{{ $lang->key }}]"
                                                        rows="3">{{ old('mini_desc.' . $lang->key, $blog->getTranslation('mini_desc', $lang->key)) }}</textarea>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="content_{{ $lang->key }}">Content in
                                                        {{ ucfirst($lang->name) }}</label>
                                ...
                                <div class="card-body p-4 row">
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select multiple-select-field w-100"
                                            data-placeholder="Choose Categories" name="categories_id[]" multiple>
                                            <option value="" disabled>
                                                {{ ucfirst(TranslationHelper::translate('Select Categories')) }}</option>
                                            @foreach ($categories as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ in_array($item->id, $blog->categories->pluck('id')->toArray()) ? 'selected' : '' }}>
                                                    {{ $item->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" class="form-control-file dropify" id="banner"
                                            name="banner"
                                            data-default-file="{{ $blog->banner ? asset('storage/' . $blog->banner) : '' }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" class="form-control-file dropify" id="video"
                                            ...
                                            data-default-file="{{ $blog->video ? asset('storage/' . $blog->video) : '' }}">
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        <label for="sort">Sort:</label>
                                        <input type="number" class="form-control" id="sort" name="sort"
                                            value="{{ old('sort', $blog->sort ?? 0) }}" required>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="show_in_home_yes"
                                                value="1" name="show_in_home"
                                                {{ $blog->show_in_home == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="show_in_home_yes">Yes</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="show_in_home_no"
                                                value="0" name="show_in_home"
                                                {{ $blog->show_in_home == 0 ? 'checked' : '' }}>

...
class CareersTableViewModel extends ViewModel
{
    public  $StaticTable;
    public  $type;
    public  $translation;
    ...
    public function __construct($StaticTable = null)
    {
        ...
        $this->routeCreate = route('admin.about.careers.create',Request()->query());
        $this->routeView = route('admin.about.careers.index',Request()->query());
        $this->viewTable = 'Careers';
    ...
    public function action(): string
    {
        return is_null($this->StaticTable->id)
            ? route('admin.about.careers.store')
            : route('admin.about.careers.update', $this->StaticTable->id);
    }

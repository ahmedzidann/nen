...
<?php endif; ?>
                                                    <div class="col-sm-12">
                                                        <?php if (isset($component)) { $__componentOriginal375f0ed4f8ee156e823aad8b1382f853 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal375f0ed4f8ee156e823aad8b1382f853 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form.input','data' => ['model' => $StaticTable,'nameImage' => 'video','old' => 'video','name' => 'video','type' => 'file','readonly' => '','placeholder' => 'Please Enter video','id' => 'video','class' => 'dropify','dataHeight' => '300','accept' => '.mp4, .mov, video/mp4, video/quicktime']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($StaticTable),'nameImage' => 'video','old' => 'video','name' => 'video','type' => 'file','readonly' => '','placeholder' => 'Please Enter video','id' => 'video','class' => 'dropify','DataHeight' => '300','accept' => '.mp4, .mov, video/mp4, video/quicktime']); ?>
                                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal375f0ed4f8ee156e823aad8b1382f853)): ?>
<?php $attributes = $__attributesOriginal375f0ed4f8ee156e823aad8b1382f853; ?>
...
<?php endif; ?>
                                                ...
                                                <?php if($StaticTable->video): ?>
                                                <div class="col-md-2">
                                                    <video controls width="500">
                                                        <source src="<?php echo e(url('storage/'.$StaticTable->video)); ?>" type="video/mp4">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($link->translate('title', $item->key)).'','name' => ''.e('links_title['.$item->key.'][]').'','type' => 'text','required' => '','placeholder' => 'title '.e($item->name).'','class' => 'form-control valid']); ?>
                                                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal375f0ed4f8ee156e823aad8b1382f853)): ?>
<?php $attributes = $__attributesOriginal375f0ed4f8ee156e823aad8b1382f853; ?>
...
<?php endif; ?>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <?php if (isset($component)) { $__componentOriginal375f0ed4f8ee156e823aad8b1382f853 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal375f0ed4f8ee156e823aad8b1382f853 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form.input','data' => ['name' => 'links_title[]','type' => 'text','required' => '','placeholder' => 'title','class' => 'form-control valid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'links_title[]','type' => 'text','required' => '','placeholder' => 'title','class' => 'form-control valid']); ?>
                                                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal375f0ed4f8ee156e823aad8b1382f853)): ?>
<?php $attributes = $__attributesOriginal375f0ed4f8ee156e823aad8b1382f853; ?>
                                                        ...
                                                        <div class="col-md-12 mb-4 row">
                                                            <div class="col-md-4 row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                   ...
                                                                   <a href="<?php echo e(url('storage/Testing/' . $file->file)); ?>" class="btn btn-success donload-input-file" download>  <i class="bx bxs-download"></i>&nbsp;</a>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($file->translate('title', $item->key)).'','name' => ''.e('file_title['.$item->key.'][]').'','type' => 'text','required' => '','placeholder' => 'title '.e($item->name).'','class' => 'form-control valid']); ?>
                                                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal375f0ed4f8ee156e823aad8b1382f853)): ?>
<?php $attributes = $__attributesOriginal375f0ed4f8ee156e823aad8b1382f853; ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/nendemo2024/public_html/resources/views/admin/testing/edit.blade.php ENDPATH**/ ?>
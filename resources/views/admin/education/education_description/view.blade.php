...
@section('titleadmin')
{{ str_replace('-', ' ', ucfirst(TranslationHelper::translate('Education Description' . ' View'))) }}
@endsection
@section('cssadmin')
@endsection
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <br>
                <a href="{{route('admin.education-descriptions.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                ...
                <table id="yajra-datatable"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>{{ TranslationHelper::translate(ucfirst('Sub Page') ?? '') }}</th>
...
<script>
    ...
    let url = "{{ route('admin.education-descriptions.index', [':id']) }}";
    ...
    $(document).ready(function() {
        ...
        bulkDelete(table, "{{ route('admin.education-descriptions.delete_bulck') }}");

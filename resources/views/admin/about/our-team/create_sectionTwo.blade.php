                                            ...
                                            <div class="card-body p-4 row">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    ...
                                                    <x-admin.form.input old="{{ 'name.' . $translationFirst->key }}"
                                                        name="{{ 'name' . '[' . $translationFirst->key . ']' }}"
                                                        type="text" required=""
                                                        placeholder="name {{ $translationFirst->name }}"
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <x-admin.form.label-first star="*" class="form-label"
                                                        name="jop  {{ $translationFirst->name }}">
                                                    </x-admin.form.label-first>
                                                    <x-admin.form.input old="{{ 'jop.' . $translationFirst->key }}"
                                                        name="{{ 'jop' . '[' . $translationFirst->key . ']' }}"
                                                        type="text" required=""
                                                        placeholder="jop {{ $translationFirst->name }}"
                                                        class="form-control valid" :value="$StaticTable->translate(
                                                            'jop',
                                                            $translationFirst->key,
                                                        )">
                                                    ...
                                                    <x-admin.form.label-end star="*"
                                                        name="please enter jop  {{ $translationFirst->name }}">
                                                    </x-admin.form.label-end>
                                                </div>
                                                {{-- ----------end jop --}}
                                                {{-- ----------first image --}}
                                                ...
                                                <div class="col-md-12 mb-4">
                                                    ...
                                                    <x-admin.form.input old="{{ 'facebook' }}"
                                                        name="{{ 'facebook' }}" type="text" required=""
                                                        placeholder="facebook" class="form-control valid" :value="$StaticTable->facebook">
                                                    </x-admin.form.input>
                                                ...
                                                <div class="col-md-12 mb-4">
                                                    ...
                                                    <x-admin.form.input old="{{ 'whatsapp' }}"
                                                        name="{{ 'whatsapp' }}" type="text" required=""
                                                        placeholder="whatsapp" class="form-control valid"
                                                ...
                                                <div class="col-md-12 mb-4">
                                                    ...
                                                    <x-admin.form.input old="{{ 'instagrame' }}"
                                                        name="{{ 'instagrame' }}" type="text" required=""
                                                        placeholder="instagrame" class="form-control valid"
...
@section('jsadmin')
    ...
    <script src="{{ asset('admin/about/ourteam/js/create.js') }}"></script>
@endsection

...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header"><h5 class="mb-0">Create Video Section</h5></div>
            <div class="card-body">
                            ...
                            <div class="row g-3 mt-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description[{{ $item->key }}]"
                                        ...
                                        rows="4" placeholder="Description in {{ ucfirst($item->name) }}">{{ old('description.' . $item->key) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="button_text[{{ $item->key }}]"
                                        value="{{ old('button_text.' . $item->key) }}"
                                        class="form-control"

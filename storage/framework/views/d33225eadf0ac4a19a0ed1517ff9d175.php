...
<?php endif; ?>
        ...
        <?php if(Request()->category == 'about' && Request()->subcategory == 'identity' && (Request()->item == 'section-one' ||Request()->item == 'section-three')): ?>

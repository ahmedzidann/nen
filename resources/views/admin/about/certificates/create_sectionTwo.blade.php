                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <x-admin.form.label-first class="form-label"
                                                    name="Sub Sub Title  {{ $translationFirst->name  }}">
                                                </x-admin.form.label-first>
                                                <x-admin.form.input old="{{ 'subsubtitle.'.$translationFirst->key }}"
                                                    name="{{ 'subsubtitle'.'['.$translationFirst->key.']' }}"
                                                    type="text" required=""
                                                    placeholder="Sub Sub Title {{ $translationFirst->name }}"
                                                    class="form-control valid"
                                                    :value="$StaticTable->translate('subsubtitle', $translationFirst->key)">
                                                </x-admin.form.input>
                                                <x-admin.form.label-end
                                                    name="please enter Sub Sub Title  {{ $translationFirst->name  }}">
                                                </x-admin.form.label-end>
                                            </div>
                                            {{-- ----------end subsubtitle --}}
                                            {{-- ----------start url --}}
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <x-admin.form.label-first star="*" class="form-label"
                                                    name="Years Text  {{ $translationFirst->name  }}">
                                                </x-admin.form.label-first>
                                                <x-admin.form.input old="{{ 'years_text.'.$translationFirst->key }}"
                                                    name="{{ 'years_text'.'['.$translationFirst->key.']' }}" type="text"
                                                    required="" placeholder="Years Text {{ $translationFirst->name }}"
                                                    class="form-control valid"
                                                    :value="$StaticTable->translate('years_text', $translationFirst->key)">
                                                </x-admin.form.input>
                                                <x-admin.form.label-end star="*"
                                                    name="please enter years_text  {{ $translationFirst->name  }}">
                                                </x-admin.form.label-end>
                                            </div>
                                            {{-- ----------end years_text --}}
                                            {{-- ----------Description first --}}

                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <x-admin.form.input old="{{ 'title.'.$translationFirst->key }}"
                                                    ...
                                                    type="text"
                                                    placeholder="title {{ ucfirst($translationFirst->name)  }}"
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <x-admin.form.input :model="$StaticTable" nameImage="AboutTabs"
...
<script src="{{ asset('admin/project/tabs/about/js/create.js') }}"></script>
@endsection
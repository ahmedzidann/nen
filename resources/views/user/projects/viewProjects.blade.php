                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-7 order-md-2">
                                <div class="who-us-titles text-start">
                                    ...
                                    <p id="shortDescription" class="short-description my-4 lh-lg text-muted">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-about" role="tabpanel" aria-labelledby="pills-about-tab"
                ...
                <div class="who_us">
                    ...
                    </div @endif <div class="whou_us_img">
                            ...
                            <ul class="nav nav-pills ul_tabs mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active tab_active" id="chalange_btn_tab"
                                        data-bs-toggle="pill" data-bs-target="#challang_tab" type="button" role="tab"
                                        aria-controls="challang_tab" aria-selected="true">Challenge
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link btn_tabs" id="solution_btn_tab" data-bs-toggle="pill"

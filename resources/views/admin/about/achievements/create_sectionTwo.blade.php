                                ...
                                <div class="tab-pane fade show active" id="{{ $translationFirst->id }}" role="tabpanel">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            {{-- ----------years --}}
                                            <div class="col-md-6">
                                                <x-admin.form.label-first star="*" class="form-label" name="years">
                                                </x-admin.form.label-first>
                                                <x-admin.form.input old="{{ 'years' }}" name="{{ 'years' }}"
                                                    type="number" required="" placeholder="years"
                                                    class="form-control valid" :value="$StaticTable->years">
                                                </x-admin.form.input>
                                                <x-admin.form.label-end star="*" name="please enter Years">
                                                </x-admin.form.label-end>
                                            </div>
                                            {{-- ----------years --}}
                                            {{-- ----------start month --}}
...
<script src="{{ asset('admin/about/achievements/js/create.js') }}"></script>
@endsection

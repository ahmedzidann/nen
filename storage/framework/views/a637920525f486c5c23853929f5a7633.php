...
<?php endif; ?>
           ...
           <?php echo $__env->make('admin.about.investors.modal.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--end row-->
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(asset('admin/about/investors/js/edit.js')); ?>"></script>

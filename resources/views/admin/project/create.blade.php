                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <x-admin.form.dropdown disabled="" required="" :foreach="$allPage" name="pages_id" nameselect="Category" :model="$StaticTable">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <x-admin.form.input :model="$StaticTable" nameImage="Project" old="image" name="image" type="file" readonly="" placeholder="Please Enter Image" id="image" class="dropify" DataHeight="300" accept=".jpg, .png, image/jpeg, image/png">
                                                    </x-admin.form.input>
                                                </div>
                                            </div>
                                            {{-- ----------end image--}}

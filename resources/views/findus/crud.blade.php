                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        ...
                                                        <x-admin.form.label-first star="*"
                                                            ...
                                                            name="countries"></x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <select name="country_id" id="country_id"
                                                                ...
                                                                @foreach ($countries as $country)
                                                                    <option value="{{ $country->id }}"
                                                                        {{ isset($admin->state) && $admin->state->country_id == $country->id ? 'selected' : '' }}>
                                                                        {{ $country->translate('title', $item->key) }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label"
                                                            name="states"></x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <select name="state_id" id="state_id"
                                                                ...
                                                                @foreach ($states as $state)
                                                                    <option value="{{ $state->id }}"
                                                                        ...
                                                                        {{ isset($admin) && $admin->state_id == $state->id ? 'selected' : '' }}>
                                                                        {{ $state->translate('title', $item->key) }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="page  ">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <select name="page_id" class="form-control valid">
                                                                <option value="" selected disabled>Select Page
                                                                </option>

                                                                @foreach ($pages as $country)
                                                                    <option value="{{ $country->id }}"
                                                                        {{ isset($admin) && $admin->page_id == $country->id ? 'selected' : '' }}>
                                                                        {{ $country->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                        ...
                                        @endif --}}
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label"
                                                            name="levels"></x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <select name="level_id" id="level_id"
                                                                class="form-control valid">
                                                                <option value="" selected disabled>Select Level
                                                                </option>
                                                                @foreach ($levels as $level)
                                                                    <option value="{{ $level->id }}"
                                                                        data-category="{{ $level->category_id }}"
                                                                        {{ isset($admin) && $admin->level_id == $level->id ? 'selected' : '' }}>
                                                                        {{ $level->translate('title', $item->key) }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label"
                                                            name="certificates"></x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <select name="certificate_id" id="certificate_id"
                                                                class="form-control valid">
                                                                <option value="" selected disabled>Select Certificate
                                                                </option>
                                                                @foreach ($certificates as $certificate)
                                                                    <option value="{{ $certificate->id }}"
                                                                        data-category="{{ $certificate->category_id }}"
                                                                        {{ isset($admin) && $admin->certificate_id == $certificate->id ? 'selected' : '' }}>
                                                                        {{ $certificate->translate('title', $item->key) }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label"
                                                            name="specialization"></x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <select name="specialization_id" id="specialization_id"
                                                                ...
                                                                @foreach ($specs as $certificate)
                                                                    <option value="{{ $certificate->id }}"
                                                                        data-category="{{ $certificate->category_id }}"
                                                                        {{ isset($admin) && $admin->specialization_id == $certificate->id ? 'selected' : '' }}>
                                                                        {{ $certificate->translate('title', $item->key) }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                @if ($loop->first)
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="code">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="code" name="code" type="text"
                                                                placeholder="Code" class="form-control valid"
                                                                required='true' :value="$admin->code ?? ''">
                                                            </x-admin.form.input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="name">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="name" name="name"
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="phone">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="email">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="address">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="address" name="address"
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="lat">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="lat" name="lat"
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="lng">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="lng" name="lng"
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="status">
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="join date">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="join_date" name="join_date"
                                                                type="date" placeholder="join_date"
                                                                class="form-control valid" required='true'
                                                                :value="$admin->join_date ?? ''">
                                                            </x-admin.form.input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="end date">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="end_date" name="end_date"
                                                                type="date" placeholder="Lang"
                                                                class="form-control valid" required='true'
                                                                :value="$admin->end_date ?? ''">
                                                            </x-admin.form.input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="start date">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="start_date" name="start_date"
                                                                type="date" placeholder="Lang"
                                                                class="form-control valid" required='true'
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="user comment">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="user_comment" name="user_comment"
                                                                type="text" placeholder="" class="form-control valid"
                                                                required='true' :value="$admin->user_comment ?? ''">
                                                            </x-admin.form.input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <x-admin.form.label-first star="*"
                                                            class="col-sm-3 col-form-label" name="admin comment">
                                                        </x-admin.form.label-first>
                                                        <div class="col-sm-9">
                                                            <x-admin.form.input old="admin_comment" name="admin_comment"
                                                                type="text" placeholder="" class="form-control valid"
                                                                required='true' :value="$admin->admin_comment ?? ''">
                                                            </x-admin.form.input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="input-template" class="input-temp" style="display:none;">
                                                        <div class="col-md-12 mb-4 row">
                                                            <div class="col-md-10 row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <x-admin.form.input name="links[]" type="file"
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <x-admin.form.input name="links_title" type="text"
                                                    ...
                                                    <div>
                                                        <div class="col-md-12">
                                                            <div id='inputs-container'>
                                                                <label>Gallery</label>
                                                                <div id="input-template2" class="input-temp"
                                                                    style="">
                                                                    <div class="col-md-12 mb-4 row">
                                                                        <div class="col-md-10 row">
                                                                            {{-- <x-admin.form.label-first star="*" class="form-label" name="Title">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                ...
                                                                                <x-admin.form.input name="links_title"
                                                                                    type="text" required=""
                                                                                    placeholder="title"
                                                                                    class="form-control valid">
                                                                                </x-admin.form.input>

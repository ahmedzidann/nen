    ...
    {{--  terms  --}}
       {{-- ----------Description second --}}
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <x-admin.form.text old="{{ 'sub_description.'.$translationFirst->key }}"
                                                    name="{{ 'sub_description'.'['.$translationFirst->key.']' }}"
                                                    type="text"
                                                    placeholder="Terms {{ ucfirst($translationFirst->name)  }}"
                                                    :value="$StaticTable->translate('sub_description', $translationFirst->key)">
                                                </x-admin.form.text>
                                                <x-admin.form.label-end star="*"
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <x-admin.form.input :model="$StaticTable" nameImage="JoinusTerms"
                                                        ...
                                                        placeholder="Please Enter Image" id="image2" class="dropify"
                                                        DataHeight="300" accept=".jpg, .png, image/jpeg, image/png">
                                                    </x-admin.form.input>
                                                </div>
                                            </div>

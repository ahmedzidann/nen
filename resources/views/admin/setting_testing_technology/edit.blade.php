                        ...
                        <div class="tab-content py-3">
                            ...
                            @foreach ($translation as $key => $item)
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                    ...
                                    <form method="POST"
                                          id="myForm{{ $key }}"
                                          action="{{ route('admin.setting_technology_testing.update', [$type, $resource->id]) }}"
                                        ...
                                        <div class="card-body p-4 row">
                                            ...
                                            @if ($loop->first)
                                                <div class="col-md-12 mb-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="form-label">
                                                            {{ ucfirst(TranslationHelper::translate('Description')) }}
                                                            <span style="color:red">*</span>
                                                        </label>
                                                        <textarea rows="4" class="form-control"
                                                                  placeholder="Description"
                                                                  name="description[{{ $item->key }}]">{{ $resource->getTranslation('description', $item->key) }}</textarea>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <label class="form-label">
                                                            {{ ucfirst(TranslationHelper::translate('Image1')) }}
                                                        </label>
                                                    ...
                                                    <div class="col-md-12 mt-4">
                                                        <label class="form-label">Checked switch checkbox status</label>
...
$(document).ready(function() {
    ...
    // On page load: populate subcategories
    (function getChild() {

...
class AwardsController extends Controller
{
    ...
    {
        return view('admin.about.awards.view',new AwardsTableViewModel());
    }
    ...
    public function store(AwardsRequest $request)
    {
        ...
        if($validator->fails())
        {
            ...
            redirect()->route('admin.about.awards.index')->with('add','Success Add Awards');
            return response()->json([
                'status'=>200,
                'message'=>'Success Add Awards',
                'redirect_url' => route('admin.about.awards.index',['category='.$request->category,'subcategory='.$request->subcategory,'item='.$request->item]),
            ]);
        }
    }
    ...
    public function destroy(Request $request):RedirectResponse
    {
        ...
        return redirect()->back()->with('delete','Delete Awards');
    }
}

...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <x-admin.form.filter nameone="Create Slide" nametwo="Create Section Two" customzie="tabproject" :routeCreatesectionTwo="$routeCreatesectionTwo" :route="$routeCreate"></x-admin.form.filter>
        <div class="card-body">

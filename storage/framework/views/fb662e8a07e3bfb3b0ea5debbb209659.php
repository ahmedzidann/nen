...
<?php endif; ?>
        ...
        <?php if(Request()->category == 'about' && Request()->subcategory == 'identity' && Request()->item == 'section-one'): ?>
...
<script src="<?php echo e(asset('admin/about/identity/js/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/nendemo2024/public_html/resources/views/admin/about/identity/view.blade.php ENDPATH**/ ?>
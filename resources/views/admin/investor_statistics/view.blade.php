...
@section('titleadmin')
    {{ str_replace('-', ' ', ucfirst(TranslationHelper::translate('Investor Statistics' . ' View'))) }}
@endsection
@section('cssadmin')
@endsection
        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <br>
                    <a href="{{route('admin.investor-statistics.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                    ...
                    <table id="yajra-datatable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>{{ TranslationHelper::translate(ucfirst('year') ?? '') }}</th>
                                <th>{{ TranslationHelper::translate(ucfirst('Capital Value') ?? '') }}</th>
                                <th>{{ TranslationHelper::translate(ucfirst('Revenue Value') ?? '') }}</th>
                                <th>{{ TranslationHelper::translate(ucfirst('Profit Value') ?? '') }}</th>
...
@section('jsadmin')
    ...
    <script>
        ...
        let url = '{{ route('admin.investor-statistics.index') }}'
        ...
        $(document).ready(function() {
            ...
            bulkDelete(table, "{{ route('admin.investor-statistics.delete_bulck') }}");

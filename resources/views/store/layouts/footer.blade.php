          ...
          <div class="row row-cols-1 row-cols-lg-4 g-4">
              <div class="col">
                  <div class="footer-widget-6">
                      <img src="{{ asset('store') }}/assets/images/logo.svg" class="logo-img mb-3" alt="">
      ...
      <div class="offcanvas-body">
          <div class="cart-list">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/01.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/02.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/03.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/04.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/05.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/06.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/07.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/08.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/09.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">
              ...
              <div class="d-flex align-items-center gap-3">
                  <div class="bottom-product-img">
                      <a href="product-details.html">
                          <img src="{{ asset('store') }}/assets/images/new-arrival/10.webp" width="60"
                              alt="">
                      </a>
                  </div>
                  <div class="">

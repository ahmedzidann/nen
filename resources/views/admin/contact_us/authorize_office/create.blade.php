                                            ...
                                            <div class="card-body p-4 row">
                                                ...
                                                <div class="col-md-12 mb-4">
                                                    ...
                                                    <x-admin.form.input old="{{ 'address.' . $translationFirst->key }}"
                                                        name="{{ 'address' . '[' . $translationFirst->key . ']' }}"
                                                        type="text" required=""
                                                        placeholder="address {{ $translationFirst->address }}"
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    ...
                                                    <x-admin.form.input old="lat" name="lat" type="text"
                                                        required="" placeholder="Latitude" class="form-control valid"
                                                        :value="$StaticTable->lat">
                                                    </x-admin.form.input>
                                                    <x-admin.form.label-end star="*" name="please enter Latitude">
                                                    </x-admin.form.label-end>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <x-admin.form.label-first star="" class="form-label"
                                                    ...
                                                    <x-admin.form.input old="lng" name="lng" type="text"
                                                        required="" placeholder="Longitude" class="form-control valid"
                                                        :value="$StaticTable->lat">
                                                    </x-admin.form.input>
                                                    <x-admin.form.label-end star="*" name="please enter Longitude">
                                                    </x-admin.form.label-end>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <x-admin.form.label-first star="" class="form-label"
                                                    ...
                                                    <x-admin.form.input old="from_at" name="from_at" type="datetime-local"
                                                        required="" placeholder="From At" class="form-control valid"
                                                        :value="$StaticTable->from_at">
                                                    </x-admin.form.input>
                                                    <x-admin.form.label-end star="*" name="please enter From At">
                                                    </x-admin.form.label-end>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <x-admin.form.label-first star="" class="form-label"
                                                    ...
                                                    <x-admin.form.label-end star="*" name="please enter To At">
                                                    </x-admin.form.label-end>
                                                </div>

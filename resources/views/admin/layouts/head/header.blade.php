				...
				<nav class="navbar navbar-expand gap-3">
					  ...
					  <div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                                @if (App::getLocale() == 'ar')
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;" data-bs-toggle="dropdown"><img src="{{ asset('admin/assets/images/county/9.png') }}" width="22" alt="">
								</a>
                                @else
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;" data-bs-toggle="dropdown"><img src="{{ asset('admin/assets/images/county/05.png') }}" width="22" alt="">
								</a>
                                @endif
								<ul class="dropdown-menu dropdown-menu-end">
                                @if (App::getLocale() == 'ar')
									<li><a class="dropdown-item d-flex align-items-center py-2" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}"><img src="{{ asset('admin/assets/images/county/05.png') }}" width="20" alt=""><span class="ms-2">English</span></a>
									</li>
                                @endif
                                @if (App::getLocale() == 'en')
									<li><a class="dropdown-item d-flex align-items-center py-2" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}"><img src="{{ asset('admin/assets/images/county/9.png') }}" width="20" alt=""><span class="ms-2">Arabic</span></a>
									</li>
                                @endif
								</ul>
							</li>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<img src="{{ Auth::guard('admin')->user()->getFirstMediaUrl('Admin') }}" class="user-img" alt="user avatar">
							@endif
							<div class="user-info">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li>
							<a href="{{ route('admin.logout') }}" class="dropdown-item d-flex align-items-center" ><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>

		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
					@foreach (App\Models\Page::find(3)->childe as $item)
						<li><a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>{{ $item->name }}</a>
							<ul>
								<li class=""><a href="{{ route('admin.project.index',['category='.App\Models\Page::find(3)->slug,'subcategory='.$item->slug]) }}" ><i class='bx bx-radio-circle'></i>Section</a></li>
							</ul>
						</li>
					@endforeach
					</ul>
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						...
						<div class="menu-title">{{ App\Models\Page::find(4)->name }}</div>
					</a>
					<ul>
					@foreach (App\Models\Page::find(4)->childe as $item)
						<li><a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>{{ $item->name }}</a>
							<ul>
								<li class=""><a href="{{ route('admin.education.index',['category='.App\Models\Page::find(4)->slug,'subcategory='.$item->slug]) }}" ><i class='bx bx-radio-circle'></i>Section</a></li>
							</ul>
						</li>
					@endforeach
					</ul>

                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="card-body p-4 row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="mini_desc_{{ $translationFirst->key }}" name="mini_desc[{{ $translationFirst->key }}]"
                                                        rows="3">{{ old('mini_desc.' . $translationFirst->key, $StaticTable->getTranslation('mini_desc', $translationFirst->key)) }}</textarea>
                                                </div>
                                                {{-- ----------Description first --}}
                                                <div class="col-md-12 mb-4">
                                                    <x-admin.form.label-first star="*" class="form-label"
                                                            ...
                                                            <div id='inputs-container-file'>
                                                                ...
                                                                <div id="input-template-file" class="input-temp-file"
                                                                    ...
                                                                    <div class="col-md-12 mb-4 row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <button type="button"
                                                                                class="btn btn-danger delete-input-file">
                                                                                <i class="bx bxs-trash"></i>&nbsp;</button>
                                                                        </div>
                                                                    </div>
                                                                    <!-- Add more input fields as needed -->

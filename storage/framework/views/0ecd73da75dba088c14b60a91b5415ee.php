...
<?php endif; ?>
        ...
        <?php if(Request()->category == 'about' && Request()->subcategory == 'achievements' && Request()->item == 'section-one'): ?>
...
<script src="<?php echo e(asset('admin/about/achievements/js/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/nendemo2024/public_html/resources/views/admin/about/achievements/view.blade.php ENDPATH**/ ?>
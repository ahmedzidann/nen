    ...
    <div class="tabs_div">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link proj_bttn <?php echo e($loop->first ? "active":""); ?>" id="pills-tab-<?php echo e($tab->slug); ?>" data-bs-toggle="pill" data-bs-target="#pills-<?php echo e($tab->slug); ?>" type="button" role="tab" aria-controls="pills-<?php echo e($tab->slug); ?>" aria-selected="false" tabindex="-1"><?php echo e($tab->name); ?> </button>

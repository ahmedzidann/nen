                ...
                <ul class="ul_dropdown">
                    ...
                    <li class="li_drop_content">
                        ...
                        <ul class="sub_dropdowen">
                            ...
                            <?php $__currentLoopData = \App\Models\Project::where('pages_id',$sub->id )->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(route($page->slug.'.'.$sub->slug.'',['page_id'=>$sub->id, 'project_id'=>$solution->id])); ?>"><?php echo e($solution->title); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
